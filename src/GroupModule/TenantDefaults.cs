...
namespace SatelliteSite.GroupModule
{
    ...
    {
        public const string AffiliationAttach = "Component_AffiliationAttach";

        public static bool EnableCountryLogo { get; internal set; }

        public static IReadOnlyDictionary<string, string> Countries { get; }
